function fcalc(){
    ...
    if(dataF==="" || dataI===""){
        ...
        document.getElementById("datahoraI").focus()
    ...
    let aux = Math.floor(horas)
    let decimal_min = horas - aux
    let hora;
    if(decimal_min < 0.20){
   ...
   let valorfixo;
    ...
    if(hora>=24){
        ...
        if(hora%24===0){
         ...
         valorfixo = 5 + (2.5 * (hora - 1));    /* valor que será usado para o denconto ou acréssimo */
    }
